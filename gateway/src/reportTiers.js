...
const REPORT_TIERS = Object.freeze({
  ...
  LEVEL_2_BASIC: Object.freeze({
    id: "level_2_basic", label: "ATI Report — Level 2", price_usd: 49, stripe_price_id: null,
  ...
  ATI_PRO: Object.freeze({
    id: "ati_pro", label: "ATI Pro — Investment Brief", price_usd: 199, stripe_price_id: null,
    requires_owner_verification: false,
  ...
  ATI_PRO_TAX: Object.freeze({
    ...
    upgrade_from: "ati_pro", upgrade_price_usd: 499, stripe_price_id: null,
    requires_owner_verification: false,
...
function extractChartData(sourceKey, skillResults) {
  ...
  switch (sourceKey) {
    ...
    case "fractional_ownership": {
      ...
      for (const [label, keys] of structures) add(label, firstNumber(fractional, keys));
      break;
    }
    default:
  ...
  return { labels, values, unit: "USD", source: sourceKey };
}
...
module.exports = { REPORT_TIERS, getTierById, getTierByStripePriceId, listTiersForPricingPage, buildReport, extractChartData };
