...
export default function AircraftMinimumFields({ details, onChange, status }) {
  ...
  return (
    <section className="space-y-4" aria-labelledby="minimum-details-title">
      ...
      <div><h2 id="minimum-details-title" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">2. Confirm Aircraft Details</h2><p className="mt-1 text-sm text-muted-foreground">Year, make and model are required for the free market-value estimate.</p></div>
