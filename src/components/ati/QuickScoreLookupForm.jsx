...
export default function QuickScoreLookupForm({ value, onChange, onLookup, loading, error }) {
  return (
    <div className="space-y-3">
      <div>
        <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground">1. Verify N-Number in FAA Registry</p>
        <p className="mt-1 text-sm text-muted-foreground">We retrieve the available FAA registration record before estimating market value.</p>
      </div>
