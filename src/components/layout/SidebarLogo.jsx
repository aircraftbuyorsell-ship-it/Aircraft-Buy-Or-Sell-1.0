...
export default function SidebarLogo({ compact = false }) {
  ...
  const wordmarkColor = isDark ? "#fff" : "#1A1814";
  const tmColor = isDark ? "rgba(255,255,255,0.55)" : "rgba(26,24,20,0.50)";
  const chartWhite = isDark ? "#fff" : "#1A1814";
    ...
    return (
      <Link to="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
        <svg width="28" height="28" viewBox="0 0 40 40" style={{ display: "block", flexShrink: 0 }}>
          ...
          <polyline points="6,30 14,12 18,30" fill="none" stroke={chartWhite} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <span style={{ fontSize: 16, fontWeight: 800, color: wordmarkColor, letterSpacing: "-0.02em", fontFamily: "Inter, sans-serif" }}>
          ABOS<span style={{ fontSize: 8, fontWeight: 600, verticalAlign: "super", color: tmColor, marginLeft: 1 }}>™</span>
        </span>
      </Link>);
  ...
  return (
    <Link to="/" style={{ display: "flex", alignItems: "center", gap: 12, textDecoration: "none" }}>
      ...
      <svg width="44" height="44" viewBox="0 0 44 44" style={{ display: "block", flexShrink: 0 }}>
        ...
        {/* Chart line — white */}
        <polyline points="7,33 15,14 19,33" fill="none" stroke={chartWhite} strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" />
        {/* Chart line — gold */}
      ...
      <div style={{ display: "flex", flexDirection: "column", lineHeight: 1 }}>
        <span style={{
          ...
          ABOS<span style={{ fontSize: 10, fontWeight: 600, verticalAlign: "super", color: tmColor, marginLeft: 1 }}>™</span>
        </span>
        <span style={{
          fontSize: 9,
