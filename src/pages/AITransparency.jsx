...
export default function AITransparency() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "fixed", top: "-200px", left: "50%", transform: "translateX(-50%)", width: "800px", height: "500px", background: "radial-gradient(ellipse, rgba(245,194,66,0.05) 0%, transparent 70%)", pointerEvents: "none", zIndex: 0 }} />
