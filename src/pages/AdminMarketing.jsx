...
export default function AdminMarketing() {
  ...
  return <div className="dark output-shell px-4 py-6 md:px-8 md:py-8"><div className="mx-auto max-w-6xl"><HubPageHeader icon={Share2} eyebrow="Marketing Operations" title="Aircraft Social Publisher" subtitle="Turn live aircraft inventory, current market signals, and listing photography into synchronized Facebook and Instagram posts."/><SocialPublisher/></div></div>;
}