...
import { BarChart3, TrendingUp, TrendingDown, Minus, Plane, Database, Store, Cpu, Radar, Globe, AlertTriangle } from "lucide-react";
    ...
    <div className="min-h-screen" style={{ background: "transparent" }}>
      ...
      {!isLoading && (
        <div className="px-4 md:px-8 pb-5 space-y-5">
          <p className="text-[10px] tracking-[0.18em] font-bold" style={{ color: accentCyan }}>DATABASE & REGISTRY INTELLIGENCE</p>
          ...
          <div className="rounded-xl p-5" style={{ background: isDark ? "rgba(15,15,28,0.72)" : "rgba(255,255,255,0.78)", border: isDark ? "1px solid rgba(255,255,255,0.07)" : "1px solid rgba(0,0,0,0.06)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)" }}>
            <DatabaseCharts
