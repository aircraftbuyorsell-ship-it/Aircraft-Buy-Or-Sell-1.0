    ...
    <div className="min-h-screen" style={{ background: "transparent" }}>
      <div className="px-4 md:px-8 pt-8 pb-6">
        <div className="flex items-center gap-3 mb-1">
          <Link
            to="/listings"
            className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider hover:opacity-70 transition-opacity"
            style={{ color: "#D4A017" }}
          >
        ...
        <div className="flex items-end justify-between flex-wrap gap-4 mt-3">
          <div>
            ...
            <p className="text-white/40 text-[12px] mt-1.5">
              Select 2–3 aircraft to compare specs, ATI score and price.
            </p>
          </div>
          {selected.length < 3 && (
            <button
              ...
              style={{ background: "#D4A017", color: "#0B1220", border: "none" }}
            >
