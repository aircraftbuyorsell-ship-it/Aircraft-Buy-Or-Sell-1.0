...
const SECTION_STYLE = "bg-card border border-border rounded-2xl p-6 md:p-8";
const H2_STYLE = "flex items-center gap-2 text-[13px] uppercase tracking-[0.15em] font-black text-[#D4A017] mb-4";
const P_STYLE = "text-[14px] leading-relaxed text-muted-foreground mb-3";

export default function IPNotice() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="mb-10">
        <h1 className="text-3xl font-black text-foreground mb-2">Intellectual Property & Trademark Notice</h1>
        <p className="text-sm text-muted-foreground">ABOS s.r.o. · Effective date: July 4, 2026 · Version 1.0</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <section className={SECTION_STYLE}>
          ...
          <p className={P_STYLE}>
            The following names, marks, and logos are trademarks or trade names of <strong className="text-foreground">ABOS s.r.o.</strong>,
            a company registered in the Czech Republic ("ABOS"), whether or not registered in a given jurisdiction:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px] text-muted-foreground mb-3">
            <li><strong className="text-foreground">ABOS™</strong> and <strong className="text-foreground">ABOS MarketSpace™</strong> — the aviation intelligence and trading platform</li>
            <li><strong className="text-foreground">ATI™</strong> and <strong className="text-foreground">Aircraft Transparency Index™</strong> — the 8-dimension aircraft scoring methodology, its scoring rubric, labels, and report formats</li>
            <li><strong className="text-foreground">ATI Passport™</strong> and <strong className="text-foreground">ATI Card™</strong> — the aircraft trust document and shareable identity card products</li>
            <li><strong className="text-foreground">IntraZone™</strong> — the broker CRM and lead intelligence suite</li>
            <li><strong className="text-foreground">SkyBoss™</strong> — the operational intelligence dashboard</li>
            <li><strong className="text-foreground">MaxChat™</strong> — the conversational AI assistant</li>
            <li><strong className="text-foreground">WIZARD™</strong> — the guided listing and scoring workflow</li>
          </ul>
          <p className={P_STYLE}>
        ...
        <section className={SECTION_STYLE}>
          ...
          <p className={P_STYLE}>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-[14px] text-muted-foreground mb-3">
            <li><strong className="text-foreground">FAA Aircraft Registry</strong> — public U.S. government data (registration, airworthiness, engine reference)</li>
            <li><strong className="text-foreground">Trade-A-Plane</strong> (accessed via the Piloterr API) — market listing comparables used in valuations and market reports, always labeled "Aggregated market data" with source disclosure</li>
            <li><strong className="text-foreground">OpenSky Network</strong> — live ADS-B traffic data</li>
            <li><strong className="text-foreground">adsbdb / PlaneSpotters</strong> — international registry and photo lookups</li>
          </ul>
          <p className={P_STYLE}>
        ...
        <section className={SECTION_STYLE}>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px] text-muted-foreground mb-3">
            <li>Public sharing, affiliate distribution, and viral referral features for an ATI Card are <strong className="text-foreground">disabled until the aircraft owner has verified ownership</strong> and consented via the ATI Verify process.</li>
