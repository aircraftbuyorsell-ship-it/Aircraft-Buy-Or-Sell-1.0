...
export default function VerifyHub() {
  return (
    <div data-verification-assistant="true" data-verification-sources="supabase,base44,github,live-traffic,service-intelligence,dealers">
      <div className="mb-4 rounded-2xl border border-border bg-card p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">One verification engine across Registry, Identity, Ownership, Activity, Service Intelligence, Dealers and live aircraft data.</p>
          </div>
